...
import { faker } from '@faker-js/faker';
 ...
 const StaticEmail = 'testemail@mail.com'
 const RandomEmail = faker.internet.email()
 const StaticFirstName = 'Angus'
 const RandomFirstName = faker.person.firstName()
 const StaticLastName = 'Young'
 const RandomLastName = faker.person.lastName()
 const StaticUsername = 'TestUser'
 const RandomUsername = faker.internet.userName()
 const StaticPhone = '555666777'
 const RandomPhone = faker.phone.number()
 let StaticPassword = 'Password123'
...
describe('Section 2: Visual tests', () => {
    ...
    it('Favourite animal dropdown is correct', () => {
        ...
        // Check  that first element in the Animal dropdown has text Dog
